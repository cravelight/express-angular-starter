# ExpressJS/AngularJS Starter Project

**Original source generated from HotTowel Angular**

This application was originally generated using HotTowel Angular, 
a yeoman generator designed to scaffold a sample AngularJS application
conforming to John Papa's
[Opinionated Angular Style Guide for Teams](https://github.com/johnpapa/angular-styleguide/blob/master/a1/README.md).
After initial generation referenced libraries were either upgraded or replaced as needed
to bring them in line with current practices.
...
- `gulp vet`
    ...
    Performs static code analysis on all javascript files. Runs eslint and plato.
